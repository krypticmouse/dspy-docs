...
DSPy ships with [several prompt optimizers](https://dspy.ai/3.4.0b1/diving-deeper/choosing-an-optimizer/index.md), but today we’re going to focus on GEPA.
...
See [GEPA in depth](https://dspy.ai/3.4.0b1/diving-deeper/gepa-in-depth/index.md) for the full mechanics: Pareto sampling, per-predictor feedback, `auto` budget translation, and the `detailed_results` audit trail.

______________________________________________________________________

**Next:** [Saving and loading →](https://dspy.ai/3.4.0b1/getting-started/saving-and-loading/index.md)
