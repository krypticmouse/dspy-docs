...
| `engine`           | `Any`                                  | ‘auto’ prefers lm15 for representable requests; ‘litellm’ preserves the compatibility backend; ‘lm15’ refuses unsupported mappings rather than selecting LiteLLM. A custom engine implements complete(Request) -> Response and optionally stream(Request). Engines are borrowed.                                                                 | `'auto'`                                                                                                                                                                                                                                                                                                                                                        |
| `async_engine`     | `Any`                                  | Async counterpart when supplying a custom engine object.                                                                                                                                                                                                                                                                                         | `None`                                                                                                                                                                                                                                                                                                                                                          |
