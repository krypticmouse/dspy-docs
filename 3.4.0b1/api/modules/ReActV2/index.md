...
For benefits, configuration, differences from ReAct, and the plan to merge the implementation back into the canonical `dspy.ReAct` API, see [ReAct and ReActV2](https://dspy.ai/3.4.0b1/diving-deeper/react/index.md).
