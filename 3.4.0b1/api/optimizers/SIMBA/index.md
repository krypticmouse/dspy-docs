...
| ---------------------------- | -------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `metric`                     | `Callable[[Example, dict[str, Any]], float]` | A function that takes an Example and a prediction_dict as input and returns a float.                  | *required*                                                                                             |
| `bsize`                      | `int`                                        | Mini-batch size. Defaults to 32.                                                                      | `32`                                                                                                   |
| `num_candidates`             | `int`                                        | Number of new candidate programs to produce per iteration. Defaults to 6.                             | `6`                                                                                                    |
| `max_steps`                  | `int`                                        | Number of optimization steps to run. Defaults to 8.                                                   | `8`                                                                                                    |
| `max_demos`                  | `int`                                        | Maximum number of demos a predictor can hold before dropping some. Defaults to 4.                     | `4`                                                                                                    |
| `prompt_model`               | \`LM                                         | None\`                                                                                                | The model to use to evolve the program. When prompt_model is None, the globally configured lm is used. |
| `teacher_settings`           | \`dict                                       | None\`                                                                                                | Settings for the teacher model. Defaults to None.                                                      |
| `demo_input_field_maxlen`    | `int`                                        | Maximum number of characters to keep in an input field when building a new demo. Defaults to 100,000. | `100000`                                                                                               |
| `num_threads`                | \`int                                        | None\`                                                                                                | Number of threads for parallel execution. Defaults to None.                                            |
| `temperature_for_sampling`   | `float`                                      | Temperature used for picking programs during the trajectory-sampling step. Defaults to 0.2.           | `0.2`                                                                                                  |
| `temperature_for_candidates` | `float`                                      | Temperature used for picking the source program for building new candidates. Defaults to 0.2.         | `0.2`                                                                                                  |

Source code in `dspy/teleprompt/simba.py`
...
| Name       | Type            | Description                        | Default    |
| ---------- | --------------- | ---------------------------------- | ---------- |
| `student`  | `Module`        | The module to optimize             | *required* |
| `trainset` | `list[Example]` | Training examples for optimization | *required* |
...
| Type     | Description                                                          |
| -------- | -------------------------------------------------------------------- |
| `Module` | The optimized module with candidate_programs and trial_logs attached |
