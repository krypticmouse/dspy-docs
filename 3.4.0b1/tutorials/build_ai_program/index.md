...
### [Managing Conversation History](https://dspy.ai/3.4.0b1/tutorials/conversation_history/index.md)

Learn how to manage conversation history in DSPy applications.

### [Building AI Agents with DSPy](https://dspy.ai/3.4.0b1/tutorials/customer_service_agent/index.md)
...
### [Building AI Applications by Customizing DSPy Modules](https://dspy.ai/3.4.0b1/tutorials/custom_module/index.md)
...
### [Retrieval-Augmented Generation (RAG)](https://dspy.ai/3.4.0b1/tutorials/rag/index.md)
...
### [Building RAG as Agent](https://dspy.ai/3.4.0b1/tutorials/agents/index.md)
...
### [Multi-Hop RAG](https://dspy.ai/3.4.0b1/tutorials/multihop_search/index.md)
...
### [Entity Extraction](https://dspy.ai/3.4.0b1/tutorials/entity_extraction/index.md)
...
### [Classification](https://dspy.ai/3.4.0b1/tutorials/classification/index.md)

Build robust text classification systems using DSPy’s modular approach with a topic classification example.

### [Privacy-Conscious Delegation](https://dspy.ai/3.4.0b1/tutorials/papillon/index.md)
...
### [Program Of Thought](https://dspy.ai/3.4.0b1/tutorials/program_of_thought/index.md)
...
### [Image Generation Prompt iteration](https://dspy.ai/3.4.0b1/tutorials/image_generation_prompting/index.md)
...
### [Audio](https://dspy.ai/3.4.0b1/tutorials/audio/index.md)
