...
1. Get current stock price data
1. Analyze the information and provide insights
...
Many Langchain tools use async operations for better performance. For details on async tools, see the [Tools documentation](https://dspy.ai/3.4.0b1/learn/programming/tools/#async-tools).
