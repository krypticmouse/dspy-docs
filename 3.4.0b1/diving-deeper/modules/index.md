...
The save/load surface. The full lifecycle — JSON vs PKL, full-program vs state-only, `save_program=True` — lives in [Saving and loading](https://dspy.ai/3.4.0b1/diving-deeper/saving-and-loading/index.md); the methods here are what that page is about.
...
- [Saving and loading](https://dspy.ai/3.4.0b1/diving-deeper/saving-and-loading/index.md) covers the persistence story in detail.
- [Settings and context()](https://dspy.ai/3.4.0b1/diving-deeper/settings-and-context/index.md) covers how LM / adapter / callback overrides propagate into a module’s sub-modules.
