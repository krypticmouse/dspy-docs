...
Types also let us communicate structural details that are easier to express in code than in natural language. [Richer types](https://dspy.ai/current/diving-deeper/signatures-in-depth/index.md) – like Pydantic models, `TypedDicts`, or `dataclasses` – can pack plenty of details that help LMs correctly complete a task.
...
**Next:** [Class-based signatures →](https://dspy.ai/current/getting-started/class-based-signatures/index.md)
