...
1. An [`Adapter`](https://dspy.ai/current/diving-deeper/adapters/index.md) is used to render the `Signature` and its inputs into messages the `LM` can consume. By default, this is the `ChatAdapter`, but there are JSON, XML, and other variants to format your messages suitable for a given `LM`.
...
**Next:** [Expanding signatures →](https://dspy.ai/current/getting-started/expanding-signatures/index.md)
