...
### [Managing Conversation History](https://dspy.ai/current/tutorials/conversation_history/index.md)

Learn how to manage conversation history in DSPy applications.

### [Building AI Agents with DSPy](https://dspy.ai/current/tutorials/customer_service_agent/index.md)
...
### [Building AI Applications by Customizing DSPy Modules](https://dspy.ai/current/tutorials/custom_module/index.md)
...
### [Retrieval-Augmented Generation (RAG)](https://dspy.ai/current/tutorials/rag/index.md)
...
### [Building RAG as Agent](https://dspy.ai/current/tutorials/agents/index.md)
...
### [Multi-Hop RAG](https://dspy.ai/current/tutorials/multihop_search/index.md)
...
### [Entity Extraction](https://dspy.ai/current/tutorials/entity_extraction/index.md)
...
### [Classification](https://dspy.ai/current/tutorials/classification/index.md)

Build robust text classification systems using DSPy’s modular approach with a topic classification example.

### [Privacy-Conscious Delegation](https://dspy.ai/current/tutorials/papillon/index.md)
...
### [Program Of Thought](https://dspy.ai/current/tutorials/program_of_thought/index.md)
...
### [Image Generation Prompt iteration](https://dspy.ai/current/tutorials/image_generation_prompting/index.md)
...
### [Audio](https://dspy.ai/current/tutorials/audio/index.md)
