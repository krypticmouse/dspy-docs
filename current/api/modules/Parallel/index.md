...
| ------------------------ | ---------------- | -------------------------------------------------------------------------------------------------- | ------- |
| `num_threads`            | `Optional[int]`  | The number of threads to use. Defaults to settings.num_threads.                                    | `None`  |
| `max_errors`             | `Optional[int]`  | The maximum number of errors allowed before raising an exception. Defaults to settings.max_errors. | `None`  |
| `access_examples`        | `bool`           | Whether to unpack Example objects via .inputs(). Defaults to True.                                 | `True`  |
| `return_failed_examples` | `bool`           | Whether to return failed examples. Defaults to False.                                              | `False` |
| `provide_traceback`      | `Optional[bool]` | Whether to provide traceback. Defaults to None.                                                    | `None`  |
| `disable_progress_bar`   | `bool`           | Whether to disable progress bar. Defaults to False.                                                | `False` |
