...
| ----------------- | ---- | ------------------------------------------------------------------------ | ------- |
| `threshold`       |      | Minimum F1 score to accept during optimization. Defaults to 0.66.        | `0.66`  |
| `decompositional` |      | If True, uses DecompositionalSemanticRecallPrecision. Defaults to False. | `False` |
