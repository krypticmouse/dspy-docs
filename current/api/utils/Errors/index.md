...
#### `LMUnsupportedFeatureError(message: str = '', *, features: list[str] | None = None, feature: str | None = None, issues: list[str] | None = None, **kwargs: Any)`
...
| ---------- | ----------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- |
| `message`  | `str`       | Human-readable error message.                    | `''`                                                                                                           |
| `feature`  | \`str       | None\`                                           | One unsupported setting path reported by the engine.                                                           |
...
###### `features = list(features) if features is not None else [feature] if feature is not None else []`
