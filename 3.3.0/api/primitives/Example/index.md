...
dspy.Evaluate: Evaluate a program on a list of `Example`s. [`Metrics`](https://dspy.ai/3.3.0/learn/evaluation/metrics/index.md): Write metric functions that compare an `Example` with a prediction.
