...
| `num_threads`                    | \`int                                 | None\`                                                                                                                                                                                                                                                         | The number of threads to use for evaluation with Evaluate. Optional.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
See GEPA usage tutorials in [GEPA Tutorials](https://dspy.ai/3.3.0/tutorials/gepa_ai_program/index.md).
...
For advanced customization of GEPA’s instruction proposal mechanism, including custom instruction proposers and component selectors, see [Advanced Features](https://dspy.ai/3.3.0/api/optimizers/GEPA/GEPA_Advanced/index.md).
...
- [DSPy Tutorials](https://dspy.ai/3.3.0/tutorials/gepa_ai_program/index.md)
