...
- [Adapters: how signatures become prompts](https://dspy.ai/3.3.0/diving-deeper/adapters/index.md) — what `desc`, `prefix`, and types look like on the wire, and where `parse_value` does its work.
- [Modules: composing your own](https://dspy.ai/3.3.0/diving-deeper/modules/index.md) — how `Predict`, `ChainOfThought`, and your own subclasses consume signatures.
