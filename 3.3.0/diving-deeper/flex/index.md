...
- [`dspy.Flex` API reference](https://dspy.ai/3.3.0/api/modules/Flex/index.md) — constructor table, examples, and the full method list.
- [Built-in module variants](https://dspy.ai/3.3.0/diving-deeper/built-in-module-variants/index.md) — where `Flex` sits among the other non-`Predict` modules.
- [GEPA in depth](https://dspy.ai/3.3.0/diving-deeper/gepa-in-depth/index.md) — the reflective optimizer that drives `Flex`’s code search.
- [RLM: exploring large contexts with code](https://dspy.ai/3.3.0/diving-deeper/rlm/index.md) — the module `Flex` uses as its tool-enabled baseline.
