...
- [Signatures in depth](https://dspy.ai/3.3.0/diving-deeper/signatures-in-depth/index.md) — what the adapter consumes.
- [Settings and context()](https://dspy.ai/3.3.0/diving-deeper/settings-and-context/index.md) — how `configure` and `context` propagate the adapter choice.
