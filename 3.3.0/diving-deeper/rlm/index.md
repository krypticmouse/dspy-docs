...
- [Built-in module variants](https://dspy.ai/3.3.0/diving-deeper/built-in-module-variants/index.md) — where RLM sits among the other non-`Predict` modules.
- [Tools, ReAct, and MCP](https://dspy.ai/3.3.0/diving-deeper/tools-react-and-mcp/index.md) — the tool-wrapping machinery RLM reuses.
- [`dspy.RLM` API reference](https://dspy.ai/3.3.0/api/modules/RLM/index.md) — full parameter table, built-in tool list, and worked examples.
