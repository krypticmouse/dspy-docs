...
See [Signatures in depth](https://dspy.ai/3.3.0/diving-deeper/signatures-in-depth/index.md) for the rest of the surface — output validators, multi-output composition, and richer Pydantic patterns.

______________________________________________________________________

**Next:** [Changing modules →](https://dspy.ai/3.3.0/getting-started/changing-modules/index.md)
