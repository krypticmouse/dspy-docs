...
*Optimizers* close that gap. An optimizer is an algorithm that improves your program automatically, and [DSPy ships several](https://dspy.ai/3.3.0/diving-deeper/choosing-an-optimizer/index.md). Some select small input/output pairs (few-shot examples) to include in the prompt as demonstrations. Others rewrite the natural-language instructions in your signatures. A few go further and fine-tune the underlying model. What they share is a loop: run your program many times, keep the version that scores best.
...
See [Metrics and evaluation](https://dspy.ai/3.3.0/diving-deeper/metrics-and-evaluation/index.md) for composite scoring, LLM judges, and test-set hygiene.

______________________________________________________________________

**Next:** [GEPA optimization →](https://dspy.ai/3.3.0/getting-started/gepa-optimization/index.md)
