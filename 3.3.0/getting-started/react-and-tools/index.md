...
For tool authoring patterns, MCP integration, and trajectory debugging, see [Tools, ReAct, and MCP](https://dspy.ai/3.3.0/diving-deeper/tools-react-and-mcp/index.md).

______________________________________________________________________

**Next:** [Composing modules →](https://dspy.ai/3.3.0/getting-started/composing-modules/index.md)
