...
1. **`dspy.RLM`**: A [Recursive Language Model](https://dspy.ai/3.2.1/api/modules/RLM/index.md) that explores large contexts through a sandboxed Python REPL with recursive sub-LLM calls. Use when context is too large to fit in the prompt effectively.
