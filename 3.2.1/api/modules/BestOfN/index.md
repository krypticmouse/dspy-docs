...
| ------------ | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------- |
| `module`     | `Module`                              | The module to run.                                                                                                       | *required* |
| `N`          | `int`                                 | The number of times to run the module.                                                                                   | *required* |
| `reward_fn`  | `Callable[[dict, Prediction], float]` | The reward function which takes in the args passed to the module, the resulting prediction, and returns a scalar reward. | *required* |
| `threshold`  | `float`                               | The threshold for the reward function.                                                                                   | *required* |
| `fail_count` | `Optional[int]`                       | The number of times the module can fail before raising an error. Defaults to N if not provided.                          | `None`     |
