...
Assertions are deprecated and NOT supported. Please use the `dspy.Refine` module instead. (or dspy.Suggest).
...
1. Uniqueness - each generated query should differ from previously-generated queries.
