...
`ChainOfThought` is simple, but nicely demonstrates the flexibility of DSPy’s module layer. [Other modules](https://dspy.ai/3.3.1/diving-deeper/built-in-module-variants/index.md) implement other strategies, including model ensembles, coding sandboxes, and *tool-calling*, which the next section explores.

______________________________________________________________________

**Next:** [Tools with ReAct →](https://dspy.ai/3.3.1/getting-started/react-and-tools/index.md)
