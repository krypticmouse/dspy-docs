...
Read this page when you want to define, wrap, validate, or import tools. For the agent loop that decides when to call them, see [ReAct and ReActV2](https://dspy.ai/3.3.1/diving-deeper/react/index.md).
...
- [ReAct and ReActV2](https://dspy.ai/3.3.1/diving-deeper/react/index.md) — how DSPy’s agent modules choose, execute, record, and replay tools.
- [Adapters: how signatures become prompts](https://dspy.ai/3.3.1/diving-deeper/adapters/index.md) — where tool schemas and `ToolCalls` become provider requests and responses.
- [RLM: exploring large contexts with code](https://dspy.ai/3.3.1/diving-deeper/rlm/index.md) — how RLM makes supplied tools callable inside its sandbox.
- [Built-in module variants](https://dspy.ai/3.3.1/diving-deeper/built-in-module-variants/index.md) — other modules that consume tools.
- [`dspy.Tool` API reference](https://dspy.ai/3.3.1/api/primitives/Tool/index.md)
- [`dspy.ToolCalls` API reference](https://dspy.ai/3.3.1/api/primitives/ToolCalls/index.md)
