...
parameters: student: program to optimize and left modified. trainset: iterable of `Example`s eval_kwargs: optional, dict, defaults to None (no extra kwargs) Additional keywords to go into `Evaluate` for the metric.
