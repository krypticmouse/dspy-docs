...
1. It builds a multi-stage *judge* in DSPy, and uses it as a metric for evaluation.
1. It uses this judge for optimizing the `dspy.Module`, using a large model as a teacher for a small local LM.
